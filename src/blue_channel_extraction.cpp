...
{   
    ...
    std::cout << "Llamba Pool Thread           times after " << ITERATION_NUMBER << " iterations: (min): " << min(llamba_threadpool_times) << "ms (max): " << max(llamba_threadpool_times)  << "ms (average): " << average(llamba_threadpool_times) << "ms" << std::endl;
