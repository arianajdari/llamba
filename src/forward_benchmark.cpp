...
int main()
{
    ...
    for(int i = 0; i < 10; i++) {
      times.push_back(HTransSerial6());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 6, "Single Threaded"); 

    times.clear();

    for(int i = 0; i < 10; i++) {
      times.push_back(HTransParallel6());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 6, "Multi Threaded");
    ...
    for(int i = 0; i < 10; i++) {
      times.push_back(HTransSerial12());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 12, "Single Threaded");  

    times.clear();

    for(int i = 0; i < 10; i++) {
      times.push_back(HTransParallel12());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 12, "Multi Threaded");  
    ...
    for(int i = 0; i < 10; i++) {
      times.push_back(HTransSerial18());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 18, "Single Threaded");  

    times.clear();

    for(int i = 0; i < 10; i++) {
      times.push_back(HTransParallel18());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 18, "Multi Threaded");  
    ...
    for(int i = 0; i < 10; i++) {
      times.push_back(HTransSerial24());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 24, "Single Threaded");  


    times.clear();

    for(int i = 0; i < 10; i++) {
      times.push_back(HTransParallel24());
      std::this_thread::sleep_for(std::chrono::operator""ms(500));
    }

    calculate(times, 24, "Multi Threaded");  
